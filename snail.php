...
if (isset($_POST['submit']))
{
    ...
    // $sql = "INSERT INTO correios (nome, idade, cep, endereco, cidade, estado, email, telefone, codigo_rastreio) VALUES ('$nome', '$idade', '$cep', '$endereco', '$cidade', '$estado', '$email', '$telefone', '$numeroRastreio')";
}
    ...
    <div class="container">
        ...
        <form id="registration-form" action="snail.php" method="POST">
            ...
            <head>
                ...
                <br><br>
                    <input type="submit" name="submit"id="submit">Enviar</button>
